...
PENDIENTE INMEDIATO: (a) CEO restaurar .env raíz (perdido en re-clone post-wipe; stack completo local no levanta) · (b) DECISIÓN CEO: rotar password seed de admin@consultoriamd.com (crece2026!) ahora que hay cliente real — escalado, fuera de perímetro agente.
