...
PENDIENTE INMEDIATO: (a) OK CEO push 0ae8829 · (b) CEO restaurar .env raíz (perdido en re-clone post-wipe; stack completo no levanta) · (c) Carlos: redeploy + alembic upgrade head + reasignar Hannah (org propia comercial + rol oficialismo + display "Hannah") · (d) flip ADR-0009 a Accepted si CEO ratifica.
