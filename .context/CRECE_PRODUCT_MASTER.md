...
| D-23 | 2026-04-19 | **Stack de resolución de cuentas oficiales en Onboarding Wizard S5:** flujo híbrido con input manual primario + asistencia opcional. Cliente pega URLs directas → sistema valida con Apify profile actors (IG: `apify/instagram-profile-scraper`, X: `delicious_zebu/advanced-x-twitter-profile-scraper`) calculando score de confianza por heurística (full_name match +0.4 · verified +0.3 · followers>50K +0.2 · posts>20 +0.1 · umbral auto-aceptación ≥0.7) → cliente confirma cuentas elegidas antes de activar scraping. SERP automático (Brightdata/Apify geo-MX) queda como **asistencia opcional de auto-fill** pero NO como primary por falta de confiabilidad. Costo proyectado $0.05-0.15 USD onboarding + $3-5 USD/mes/cliente scraping recurrente. Scope S5 +0.5 día (no +1 día original) porque el flujo SERP complejo se elimina | Test empírico Joy 2026-04-19 con Omar García Harfuch documentó 3 modos de falla críticos: (1) Brightdata SERP MCP intermitente (HTTP 400 "No active transport"), (2) Apify SERP sin proxies retorna 0 resultados orgánicos, (3) **falso positivo silencioso en IG** — `@oharfuch` existe como tienda de joyería Rutherford (423 followers, unverified, posts 2020) pero sería asociado erróneamente a Harfuch sin disambiguación humana. El handle real `omargharfuch` (656K followers, verified) solo se encontró con input manual del CEO. Esta evidencia empírica es la razón arquitectónica más fuerte para hacer la confirmación humana obligatoria antes de cualquier scraping automatizado | 🟢 APROBADA con ajuste de diseño | `backend/research/2026-04-19/test_competidor_harfuch.md` · `backend/scripts/test_competidor_resolution.py` · `backend/research/2026-04-19/SPRINT-S5-SCOPING.md` |
