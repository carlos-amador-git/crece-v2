...
class UnidadTerritorial(Base):
    """Unidad territorial electoral — grano seccion x colonia/pueblo.
    ...
    clave_unidad_territorial: Mapped[str] = mapped_column(String(20), nullable=False, index=True)
    ...
    circunscripcion_2024: Mapped[str | None] = mapped_column(String(10), nullable=True, index=True)
    ...
    nivel_socioeconomico_resumen: Mapped[str | None] = mapped_column(String(100), nullable=True)
