...
SAMPLE_CSV = BASE_DIR / "sample_recent_oficialistas.csv"
RESULTS_CSV = BASE_DIR / "results_gemini_oficialistas.csv"
REPORT_MD = BASE_DIR / "triangulacion-gemini-oficialistas-2026-05-09.md"
